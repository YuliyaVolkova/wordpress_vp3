            ...
            while (have_posts()) :
                the_post(); ?>
                    ...
                    <div class="article-image">
                        <img src="<?= turnews_thumbnail(); ?>" alt="Image поста">
                    </div>
                    <?php if (get_post_type() === 'actions') :
                        $catActions = categoriesAction(get_the_ID(), 'departure');
                        if ($catActions !== null) : ?>
                ...
                <div class="article-pagination__block pagination-prev-left">
                    ...
                    <div class="wrap-pagination-preview pagination-prev-left">
                        <div class="preview-article__img">
                            <img src="<?= get_the_post_thumbnail_url($prev->ID); ?>" class="preview-article__image">
                        </div>
            ...
            <?php if (!empty($next)) : ?>
                <div class="article-pagination__block pagination-prev-right">
                    ...
                    <div class="wrap-pagination-preview pagination-prev-right">
                        <div class="preview-article__img">
                            <img src="<?= get_the_post_thumbnail_url($next->ID); ?>" class="preview-article__image">
                        </div>
                        <div class="preview-article__content">
                            <div class="preview-article__info">
