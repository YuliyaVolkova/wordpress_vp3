<?php
/* Plugin name: Tur actions custom post type */

if (!function_exists('action_post_type')) {
    ...
    function action_post_type()
    {
        $labels = array(
            ...
            'not_found'             => __('Акций не найдено', 'text_domain'),
        ...
        $args = array(
            ...
            'description'           => __('Action Type Description', 'text_domain'),
            'labels'                => $labels,
